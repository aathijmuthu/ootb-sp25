...
product_viewers_contributing_columns
...
added_to_cart_contributing_columns
...
checkout_started_contributing_columns
                ...
                if 'visitor' in event.lower():
                    ...
                    if not hour_data.empty:
                        ...
                        if contributors:
                            ...
                            hover_info += " (Contributors: N/A)"
                elif 'product_viewers' in event.lower():
                    # Filter product_viewers contributors for this hour
                    hour_data = product_viewers_contributing_columns[
                        product_viewers_contributing_columns['ds_x'] == current_hour
                    ]
                    if not hour_data.empty: 
                        ...
                        if contributors:
                            ...
                            hover_info += " (Contributors: N/A)"        
                elif 'added_to_cart' in event.lower():
                    # Filter added_to_cart contributors for this hour
                    hour_data = added_to_cart_contributing_columns[
                        added_to_cart_contributing_columns['ds_x'] == current_hour
                    ]   
                    if not hour_data.empty: 
                        ...
                        if contributors:
                            ...
                            hover_info += " (Contributors: N/A)"    
                elif 'checkout_started' in event.lower():
                    # Filter checkout_started contributors for this hour
                    hour_data = checkout_started_contributing_columns[
                        checkout_started_contributing_columns['ds_x'] == current_hour
                    ]   
                    if not hour_data.empty: 
...
merged['product_viewers_anomaly'] = product_viewers_top_level['is_anomaly']
merged['product_viewers_value'] = product_viewers_top_level['y']
merged['product_viewers_percent_diff'] = product_viewers_top_level['percent_diff']
merged['product_viewers_US_contribution'] = product_viewers_contributions['percent_diff US']
merged['product_viewers_Global_contribution'] = product_viewers_contributions['percent_diff Global']
merged['product_viewers_iOS_contribution'] = product_viewers_contribution_dev['percent_diff iOS']
merged['product_viewers_Android_contribution'] = product_viewers_contribution_dev['percent_diff Android']
merged['product_viewers_Linux_contribution'] = product_viewers_contribution_dev['percent_diff Linux']
merged['product_viewers_macOS_contribution'] = product_viewers_contribution_dev['percent_diff macOS']
merged['product_viewers_Other_contribution'] = product_viewers_contribution_dev['percent_diff Other']

merged['added_to_cart_anomaly'] = added_to_cart_top_level['is_anomaly']
merged['added_to_cart_value'] = added_to_cart_top_level['y']
merged['added_to_cart_percent_diff'] = added_to_cart_top_level['percent_diff']
merged['added_to_cart_US_contribution'] = added_to_cart_contributions['percent_diff US']
merged['added_to_cart_Global_contribution'] = added_to_cart_contributions['percent_diff Global']
merged['added_to_cart_iOS_contribution'] = added_to_cart_contribution_dev['percent_diff iOS']
merged['added_to_cart_Android_contribution'] = added_to_cart_contribution_dev['percent_diff Android']
merged['added_to_cart_Linux_contribution'] = added_to_cart_contribution_dev['percent_diff Linux']
merged['added_to_cart_macOS_contribution'] = added_to_cart_contribution_dev['percent_diff macOS']
merged['added_to_cart_Other_contribution'] = added_to_cart_contribution_dev['percent_diff Other']

merged['checkout_started_anomaly'] = checkout_started_top_level['is_anomaly']
merged['checkout_started_value'] = checkout_started_top_level['y']
merged['checkout_started_percent_diff'] = checkout_started_top_level['percent_diff']
merged['checkout_started_US_contribution'] = checkout_started_contributions['percent_diff US']
merged['checkout_started_Global_contribution'] = checkout_started_contributions['percent_diff Global']
merged['checkout_started_iOS_contribution'] = checkout_started_contribution_dev['percent_diff iOS']
merged['checkout_started_Android_contribution'] = checkout_started_contribution_dev['percent_diff Android']
merged['checkout_started_Linux_contribution'] = checkout_started_contribution_dev['percent_diff Linux']
merged['checkout_started_macOS_contribution'] = checkout_started_contribution_dev['percent_diff macOS']
merged['checkout_started_Other_contribution'] = checkout_started_contribution_dev['percent_diff Other']
...
def get_anomalous_metrics(row):
    ...
    if row['product_viewers_anomaly'] == 1:
        anomalies.append(f"%diff: {row['product_viewers_percent_diff']*100:.1f}%)")
    if row['added_to_cart_anomaly'] == 1:
        anomalies.append(f"%diff: {row['added_to_cart_percent_diff']*100:.1f}%)")
    if row['checkout_started_anomaly'] == 1:
        anomalies.append(f"%diff: {row['checkout_started_percent_diff']*100:.1f}%)")
...
anomaly_periods = merged[
    ...
    (merged['product_viewers_anomaly'] == 1) |
    (merged['added_to_cart_anomaly'] == 1) |
    (merged['checkout_started_anomaly'] == 1)
]
